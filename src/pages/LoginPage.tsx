    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-sm text-gray-500">Booking Service — Internal dashboard</p>
        </div>
          ...
          {!loading && firebaseUser && !isAdmin && (
            <div className="mb-4 p-3 rounded-lg bg-red-50 border border-red-200">
              <p className="text-sm text-red-700">
                <strong>Access denied.</strong> Your account does not have admin privileges.
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          Booking Service Admin &copy; {new Date().getFullYear()}
        </p>
      </div>
    </div>
  )
